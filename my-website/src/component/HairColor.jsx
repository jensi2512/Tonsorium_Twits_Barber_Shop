...
import haircolor1 from '../assets/haircolor1.jpg'
import haircolor2 from '../assets/haircolor2.jpg'
import haircolor3 from '../assets/haircolor3.jpg'
import haircolor4 from '../assets/haircolor4.jpg'
import haircolor5 from '../assets/haircolor5.jpg'
import haircolor6 from '../assets/haircolor6.jpg'
        ...
        <div>
            ...
            <div className="container-fuild mt-5 p-3">
                <div className="gallery-imgs">
                    <div className="row">
                        <div className="col-4">
                            <img src={haircolor1} alt="" style={{ height: "320px", width: "100%" }} />
                        </div>
                        <div className="col-4">
                            <img src={haircolor2} alt="" style={{ height: "320px", width: "100%" }} />
                        </div>
                        <div className="col-4">
                            <img src={haircolor3} alt="" style={{ height: "320px", width: "100%" }} />
                        </div>
                    </div>
                    <div className="row mt-3">
                        <div className="col-4">
                            <img src={haircolor4} alt="" style={{ height: "320px", width: "100%" }} />
                        </div>
                        <div className="col-4">
                            <img src={haircolor5} alt="" style={{ height: "320px", width: "100%" }} />
                        </div>
                        <div className="col-4">
                            <img src={haircolor6} alt="" style={{ height: "320px", width: "100%" }} />
                        </div>
                    </div>
                </div>
            </div>
